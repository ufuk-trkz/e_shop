...
class _LoginState extends State<Login> {
        ...
        child: Column(
          ...
          children: [
                ...
                onPressed: () {
                  _emailTextEditingController.text.isNotEmpty
                      ...
                      : showDialog(
                        context: context,
                        builder: (c) {
                          return ErrorAlertDialog(message: "Please type email and password",);
                        }
                     );
                },
              color: Colors.pink,
            ...
            FlatButton.icon(
              ...
              label: Text("Login as Admin", style: TextStyle(color: Colors.pink, fontWeight: FontWeight.bold),),
            )
          ],
        ),
      ),
  ...
  Future readData(FirebaseUser fUser) async {
    Firestore.instance.collection("users").document(fUser.uid).get().then((dataSnapshot) async {
      ...
      await EcommerceApp.sharedPreferences.setString(EcommerceApp.userPhotoUrl, dataSnapshot.data[EcommerceApp.userPhotoUrl]);
